 ...
 * Ported from chopinshown/bnoise iOS (TicketStubCard.swift)
 *
...
import { AttendBadge } from './stamp-label';
...
/** SVG photo placeholder with overlay gradient */
...
export const TicketStubCard: FC<TicketStubCardProps> = ({
  ...
  const card = (
    ...
    >
      {/* Black torn-paper backing (shadow layer) */}
      <div
